...
# Use /tmp for stateless cloud deployments (data is temporary)
# For persistent storage, use a mounted volume path like /mnt/video_database/
VIDEO_DATABASE_FOLDER = os.environ.get("VIDEO_DATABASE_FOLDER", "/tmp/video_database/")
...
# This will overwrite Azure OpenAI settings if provided
